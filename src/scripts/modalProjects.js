  ...
  return `
        ...
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-8 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Menu</h3>
                <p>O menu é composto por 3 seções: Ordens, Clientes e Trabalhos.</p>
        ...
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-10 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Clientes</h3>
                <p>A área de cadastro de clientes contém interface limpa e uma tabela de fácil visualização, permitindo atualizar e excluir informações de maneira rápida e simples.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-20 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Valores</h3>
                <p>Visão geral que levará em conta o total de valores por trabalho e calculará possíveis divergências no salário recebido.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Ordens</h3>
                <p>Cartões clicáveis que permitem uma visão ampla e controle das ordens já criadas.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Ordem</h3>
                <p>Alguns campos possuem informações pré definidas pelo banco de dados, permitindo uma adição fácil e otimizada.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-6 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Histórico</h3>
                <p>Histórico dos valores recebidos ou descontos da empresa.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
    `;
...
const tlsvProject = () => {
  return `
        ...
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Uso</h3>
                <p>Basta salvar a planilha gerada pelo aplicativo da Oracle em uma das pastas e executar para que o programa faça a leitura e retorne o arquivo com as informações desejadas.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-8 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Funcionamento</h3>
                <p>A partir da planilha, o programa seleciona os contratos e faz buscas no aplicativo da Oracle, retornando as informações dos campos definidos em código.</p>
...
const raruPharmacies = () => {
  return `
        ...
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Login</h3>
                <p>Tela inicial onde somente pessoas autorizadas e de suas respectivas áreas poderão ter acesso.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-8 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                ...
                <p>O programa conta com um sistema de níveis, onde cada funcionário tem acesso somente à sua área pertencente, as demais funções estarão bloqueadas.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 max-sm:py-8 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                ...
                <p>Permite o cadastro de produtos e a visualização de produtos com baixo estoque, mantendo maior controle das quantidades.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Usuários</h3>
                <p>O cadastro de usuários conta com senhas criptografadas e sistema de níveis para bloqueio de acesso a determinadas áreas.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>Vendas</h3>
                <p>Visualização detalhada dos itens para compra.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
...
const raruBooks = () => {
  return `
        ...
        <div class="modal_item w-full justify-center items-center flex gap-4 rounded-md mb-4">
            ...
            <div class="modal_info h-full w-full gap-2 rounded-md">
                <h3>API</h3>
                <p>Feita para controle de biblioteca, contém sistema de usuários e emprétimo por número de cópias.</p>
                <img class="h-7" src="./src/assets/icons/hover.png" alt="hover_icon">
            </div>
        </div>
    `;
